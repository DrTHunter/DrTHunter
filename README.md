...
👋 **Hey, I’m Trent Hunter**

* U.S. Army Veteran (former combat medic) and former Supervisory Management Analyst for Specialty Medicine at the Department of Veterans Affairs [1]
* After burning out on 65+ hour weeks, I rebuilt my life around full-stack development, systems design, and building tools that actually solve real problems [1]

I’m a builder — self-taught, product-driven, and focused on creating systems that are:
...
Most of my work centers on practical automation, AI-adjacent tools, and developer/productivity systems I design, deploy, and maintain end-to-end.

---

```
[ DrTHunter@fsociety ~ ]$ ls ~/currently_working_on
```

* 🔭 Secure, modular web systems
* 🔭 Local-first AI tooling for Open-WebUI (memory systems, utilities, agent tools)
* 🔭 Productivity & workflow platforms

---

```
[ DrTHunter@fsociety ~ ]$ ls ~/currently_learning
```
...
```
[ DrTHunter@fsociety ~ ]$ cat open_to_collaborating.txt
```
...
```
[ DrTHunter@fsociety ~ ]$ cat looking_for.txt
```
...
* maintainability
* reliability
* delivering working systems (not idea vapor)

---

```
[ DrTHunter@fsociety ~ ]$ cat ask_me_about.txt
```

💬 System design, self-hosted tools, ops workflows, resilience/reinvention, and the deeper philosophical side of AI + identity.

---

```
[ DrTHunter@fsociety ~ ]$ cat contact.txt
```

<a href="mailto:dr_hunter@yahoo.com"><img src="https://img.shields.io/badge/Email-dr__hunter%40yahoo.com-000000?style=for-the-badge&logo=yahoo&logoColor=white" alt="Email dr_hunter@yahoo.com"></a>

---

```
[ DrTHunter@fsociety ~ ]$ fortune
```

⚡ I’ve edited multiple book manuscripts, and I love building long-arc creative/technical systems — projects designed to evolve, endure, and outlast the moment [1].

---

```
[ DrTHunter@fsociety ~ ]$ cat stats.txt
```
